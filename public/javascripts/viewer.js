...
$(document).ready(function() {
    ...
    .live('ajax:success', function(evt, data, status, xhr){
      ...
      $('#commentList-30').append(xhr.responseText);
...
function setWidthAndHeight() {
	...
	$("#panel .wrapper").width(dimensions.width - 240);
}
...
function open_sync_window(){
    // Step1
    $("#osx-modal-data").html($("#window1 .content").html());
    $('a.osx').trigger('click');
    
    //Go forward to Step2
    $("#osx-modal-data .step2").live("click", function(){
       var selected_team = $("#osx-modal-data option:selected").val();
       if(selected_team == 0){
           return false;
       } 
       else{
           $(".selected_team").each(function(){
               $(this).html($("#osx-modal-data option:selected").text());
           });
           $("#osx-modal-data").html($("#window2 .content").html());
           
           // var h = $("#osx-modal-data").height() + $("#osx-modal-title").height() + 20; // padding
           //            $("#osx-container").animate({height: h}, 200);
       }
    });
    // Go back to Step1
    $("#osx-modal-data .step1").live("click", function(){
        $("#osx-modal-data").html($("#window1 .content").html());
    });
}
...
function start_sync(){
    ...
    $("#articles_list li a").each(function(){
...
function set_article_list_width(){
	...
	var width = count * ($(".articles_list li").first().width() + 40);
