...
Impale your application on the heartless spike of the Deployer.}
  ...
  s.files = [%q{History.txt}, %q{Manifest.txt}, %q{README.txt}, %q{considerations.txt}, %q{doco/deploying-merb-with-vlad.txt}, %q{doco/deploying-sinatra-with-vlad.txt}, %q{doco/faq.txt}, %q{doco/getting_started.txt}, %q{doco/migration.txt}, %q{doco/perforce.txt}, %q{doco/variables.txt}]
